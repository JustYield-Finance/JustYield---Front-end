...
export class WalletConnectionApi implements IWalletConnectionApi {
  ...
  private createOnboard() {
    const onboard = Onboard({
      ...
      appMetadata: {
        name: 'JustYield Finance',
        icon: require(`../../../../images/bifi-logos/header-logo-notext.png`).default,
        logo: require(`../../../../images/bifi-logos/header-logo.png`).default,
        description:
          'JustYield is a Decentralized, Multichain Yield Optimizer that allows its users to earn compound interest on their crypto holdings. JustYield earns you the highest APYs with safety and efficiency in mind.',
        gettingStartedGuide: 'https://docs.justyield.finance/',
      },
