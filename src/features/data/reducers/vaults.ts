...
function addVaultToState(
  ...
  if (apiVault.isGovVault) {
    const vault: VaultGov = {
      ...
      isOptimized: 'false',
      isRewardable: 'false',
      pendingRewards: apiVault.pendingRewards || null,
    ...
    const vault: VaultStandard = {
      ...
      name: apiVault.name,
      isGovVault: false,
      isMultiStrat: apiVault.isMultiStrat as VaultStandard['isMultiStrat'],
      isOptimized: apiVault.isOptimized as VaultStandard['isOptimized'],
      isRewardable: apiVault.isRewardable as VaultStandard['isRewardable'],
      pendingRewards: apiVault.pendingRewards || null,
