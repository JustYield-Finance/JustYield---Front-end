...
- Test vault page
  - A gov vault: https://beta.justyield.finance/#/bsc/vault/bifi-gov
  - A maxi vault: https://beta.justyield.finance/#/heco/vault/heco-bifi-maxi
  - A multi asset vault: https://beta.justyield.finance/#/fantom/vault/beets-sound-of-moosic
  - An inactive vault: https://beta.justyield.finance/#/polygon/vault/curve-poly-atricrypto
  - Another inactive vault: https://beta.justyield.finance/#/polygon/vault/quick-bifi-eth-eol
  - A boosted vault: https://beta.justyield.finance/#/bsc/vault/cakev2-cake-bnb
  - The cake vault: https://beta.justyield.finance/#/bsc/vault/cake-cakev2
  - A featured vault: https://beta.justyield.finance/#/fantom/vault/scream-wbtc
  - A single asset vault: https://beta.justyield.finance/#/polygon/vault/aave-eth
...
- Why not use https://api.justyield.finance/vaults and https://api.justyield.finance/boosts?
  The design decision to only use blockchain endpoints was lost along the way.
  Maybe one day we'll allow user to chose between using only the justyield api for fast access or only use the blockchain for effective decentralization.
  A mix between the 2 approaches is a bug, but not fixing it right now.
- why is there an api.justyield.finance and a data.justyield.finance?
  data.justyield.finance is used to query certain historical data. Api returns live results
- What is a reward?
